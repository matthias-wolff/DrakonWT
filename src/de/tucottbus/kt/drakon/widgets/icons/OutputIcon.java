 ...
 */
public class OutputIcon extends DrakonIcon
{
   ...
   *          </table>
   */
  public OutputIcon(DrakonMacro parent, int style)
  {
  ...
  protected void drawIconOn(GC gc)
  {
    ...
    int[] polygon = { 2*ht+4,4 , w-4-2*ht,4 , w-4,h/2 , w-4-2*ht,h-4 , 2*ht+4,h-4 };
