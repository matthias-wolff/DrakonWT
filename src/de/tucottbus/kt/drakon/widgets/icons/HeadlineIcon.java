 ...
 */
public class HeadlineIcon extends DrakonIcon
{

  /**
   * Creates a new headline icon.
   * 
   * @param parent
   ...
   *          </table>
   */
  public HeadlineIcon(DrakonMacro parent, int style)
  {
  ...
  protected void drawIconOn(GC gc)
  {
    ...
    int polygon[] = { 4,4 , w-4,4 , w-4,h-4 , w/2,5*h/4-4 , 4,h-4 };
